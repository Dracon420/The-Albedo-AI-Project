...
![Status](https://img.shields.io/badge/Status-v3.2.2-00F0FF?style=flat-square)
...
**v3.2.2** is a patch that fixes the 3D brain rendering; it also carries the full v3.2.1 feature set:

- **3D "Brain Atlas" visualization** — the Obsidian-vault graph is a rotating 3D node network: **crisp lit-sphere nodes** spread by a Fruchterman-Reingold force layout (v3.2.2 — was a blurry collapsed ball), grouped by folder into clusters, with depth cueing, drag-to-spin and wheel-zoom. Pure Canvas 2D — no WebGL/CDN, so it works fully offline.
...
### [⬇ Download Albedo-Setup-3.2.2.exe](https://github.com/Dracon420/The-Albedo-AI-Project/releases/download/v3.2.2/Albedo-Setup-3.2.2.exe)
...
1. **Download** `Albedo-Setup-3.2.2.exe` from the link above
...
| Re-run `Albedo-Setup-3.2.2.exe` | Upgrades in-place, preserves all user data |
